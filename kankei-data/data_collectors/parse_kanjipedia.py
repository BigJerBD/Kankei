...
def make_meaning_groups(meaning_str):
    #todo: not good we want to split but also keep the misc value
    #todo : better method would be to update regex_info to get all, then split ( and it would be perfect
    first_part, *parts = re.split(misc_tag_regex, meaning_str)

    # todo make a tuple upthere
    meaning_list = [
