from data.elements.link import Link, SimplifiedLink
from data.elements.proprety_types import Int, String, List
from language import japanese as jp


class HasCategory(SimplifiedLink):
    ...


class HasDefinition(SimplifiedLink):
    ...


class HasMeaning(SimplifiedLink):
    ...


class HasRadical(SimplifiedLink):
    ...
